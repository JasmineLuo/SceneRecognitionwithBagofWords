...
%% RUN THE VL_SETUP MANUALLY
vl_setup;

data_path = '/Users/luozhongyi/Desktop/2015 Fall course/CS 6476/proj4/data'; %change if you want to work with a network copy
...
switch lower(FEATURE)    
    ...
    case 'fisher code'
        [train_image_feats, test_image_feats] = fisher(train_image_paths, test_image_paths);
...
%% For debug
save('trainfeaturenorm4.mat','train_image_feats');
save('trainlabelnorm4.mat','train_labels');
save('testfeaturenorm4.mat','test_image_feats');
%% end
...
switch lower(CLASSIFIER)    
    ...
    case 'nbnn'
        predicted_categories = NBNN(train_image_path, test_image_path, train_labels);        
    otherwise
